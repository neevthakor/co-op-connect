...
export const metadata = {
  title: "Society Requests - Co-opConnect",
};

export default async function SocietyRequestsPage() {
    ...
    <div className="space-y-6">
      <div className="flex justify-between items-center">
        <div>
          ...
          <p className="text-muted-foreground">Manage and track service requests for your society.</p>
        </div>
        <Link href="/society/requests/create">
          <Button>
          ...
          <Card key={req.id}>
            ...
            <CardContent className="text-sm space-y-2">
              ...
              <div className="flex items-center gap-4 text-muted-foreground mt-4">
                <span className="flex items-center gap-1"><MapPin className="w-4 h-4" /> {req.location?.name || req.area || "Location not specified"}</span>
            ...
            <CardFooter className="pt-3 border-t flex justify-between items-center">
              ...
              <Link href={`/society/requests/${req.id}`}>
