...
export const metadata = {
  title: "Create Request - Co-opConnect",
};
...
export default async function CreateSocietyRequestPage() {
  ...
  async function createRequest(formData: FormData) {
    ...
    redirect(`/society/requests/${request.id}`);
  }
  ...
  return (
    <div className="max-w-2xl mx-auto space-y-6">
      <div>
        ...
        <p className="text-muted-foreground">Request maintenance, repair, or services for your society.</p>
      </div>
        ...
        <form action={createRequest}>
          ...
          <CardContent className="space-y-4">
            ...
            <div className="space-y-2">
              ...
              <Textarea name="description" required placeholder="Detailed explanation of the required service..." rows={4} />
            </div>
